...
extension CoreML_Specification_Pipeline: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_PipelineClassifier: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_PipelineRegressor: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_FeatureDescription: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_Metadata: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 100: try decoder.decodeMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufString>.self, value: &self.userDefined)
      default: break
      }
    }
  }
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    ...
    if !self.userDefined.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufString>.self, value: self.userDefined, fieldNumber: 100)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension CoreML_Specification_ModelDescription: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_Model: Message, _MessageImplementationBase, _ProtoNameProviding {
