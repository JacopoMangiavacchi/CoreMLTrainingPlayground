...
extension CoreML_Specification_Normalizer: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_Normalizer.NormType: _ProtoNameProviding {
  static let _protobuf_nameMap: _NameMap = [
    0: .same(proto: "LMax"),
    1: .same(proto: "L1"),
    2: .same(proto: "L2"),
