...
extension CoreML_Specification_GLMRegressor: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_GLMRegressor.PostEvaluationTransform: _ProtoNameProviding {
  static let _protobuf_nameMap: _NameMap = [
...
extension CoreML_Specification_GLMRegressor.DoubleArray: Message, _MessageImplementationBase, _ProtoNameProviding {
