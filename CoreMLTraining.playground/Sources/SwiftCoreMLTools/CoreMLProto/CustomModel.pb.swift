...
extension CoreML_Specification_CustomModel: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 30: try decoder.decodeMapField(fieldType: _ProtobufMessageMap<ProtobufString,CoreML_Specification_CustomModel.CustomModelParamValue>.self, value: &self.parameters)
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    ...
    if !self.parameters.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMessageMap<ProtobufString,CoreML_Specification_CustomModel.CustomModelParamValue>.self, value: self.parameters, fieldNumber: 30)
    }
...
extension CoreML_Specification_CustomModel.CustomModelParamValue: Message, _MessageImplementationBase, _ProtoNameProviding {
