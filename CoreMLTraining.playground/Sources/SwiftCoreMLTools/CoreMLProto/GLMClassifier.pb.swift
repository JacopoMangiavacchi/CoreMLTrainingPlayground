...
struct CoreML_Specification_GLMClassifier {
  ...
  enum PostEvaluationTransform: Enum {
...
extension CoreML_Specification_GLMClassifier: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_GLMClassifier.PostEvaluationTransform: _ProtoNameProviding {
  static let _protobuf_nameMap: _NameMap = [
    0: .same(proto: "Logit"),
    1: .same(proto: "Probit"),
  ]
...
extension CoreML_Specification_GLMClassifier.ClassEncoding: _ProtoNameProviding {
  static let _protobuf_nameMap: _NameMap = [
...
extension CoreML_Specification_GLMClassifier.DoubleArray: Message, _MessageImplementationBase, _ProtoNameProviding {
