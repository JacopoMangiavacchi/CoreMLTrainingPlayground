...
extension CoreML_Specification_StringToInt64Map: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufInt64>.self, value: &self.map)
      default: break
      }
    }
  }
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    if !self.map.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufInt64>.self, value: self.map, fieldNumber: 1)
    }
...
extension CoreML_Specification_Int64ToStringMap: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: _ProtobufMap<ProtobufInt64,ProtobufString>.self, value: &self.map)
      default: break
      }
    }
  }
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    if !self.map.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMap<ProtobufInt64,ProtobufString>.self, value: self.map, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension CoreML_Specification_StringToDoubleMap: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufDouble>.self, value: &self.map)
      default: break
      }
    }
  }
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    if !self.map.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMap<ProtobufString,ProtobufDouble>.self, value: self.map, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension CoreML_Specification_Int64ToDoubleMap: Message, _MessageImplementationBase, _ProtoNameProviding {
  ...
  mutating func decodeMessage<D: Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: _ProtobufMap<ProtobufInt64,ProtobufDouble>.self, value: &self.map)
      default: break
      }
    }
  }
  ...
  func traverse<V: Visitor>(visitor: inout V) throws {
    if !self.map.isEmpty {
      try visitor.visitMapField(fieldType: _ProtobufMap<ProtobufInt64,ProtobufDouble>.self, value: self.map, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension CoreML_Specification_StringVector: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_Int64Vector: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_FloatVector: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_DoubleVector: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_Int64Range: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_Int64Set: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_DoubleRange: Message, _MessageImplementationBase, _ProtoNameProviding {
