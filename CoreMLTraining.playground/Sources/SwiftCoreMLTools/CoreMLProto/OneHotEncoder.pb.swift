...
extension CoreML_Specification_OneHotEncoder: Message, _MessageImplementationBase, _ProtoNameProviding {
...
extension CoreML_Specification_OneHotEncoder.HandleUnknown: _ProtoNameProviding {
  static let _protobuf_nameMap: _NameMap = [
